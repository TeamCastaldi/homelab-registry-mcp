...
def register_linking_tools(
    ...
    def pre_update_compatibility_check(name: str) -> str:
        ...
        return (
            ...
            "flag any hostname that is not a valid RFC-1123 label — underscores, "
            "uppercase letters, or leading/trailing hyphens are all invalid and are "
            ...
            "application/provider's external host against the same RFC-1123 rule.\n"
