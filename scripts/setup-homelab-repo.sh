...
echo ""
echo "  1. Copy the git-crypt key to your password manager (Vaultwarden, etc.):"
echo "     ${SECRETS_KEY_PATH}"
echo ""
echo "  2. Add these to the registry-mcp .env on Watchtower:"
echo "     SECRETS_ENABLED=true"
echo "     SECRETS_REPO_PATH=${SECRETS_REPO_PATH}"
echo "     SECRETS_KEY_PATH=${SECRETS_KEY_PATH}"
echo "     # OR base64-encode the key and set:"
...
echo "  unrecoverable. Store it in Vaultwarden NOW."
echo ""
